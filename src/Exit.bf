namespace ijoLang
{
    public enum Exit: int
    {
        ...
        */
        ...
        /**
        * A service is unavailable.  This can occur if a supÂ­
        ...
        * the operation.  This is not intended for file sysÂ­
        * tem problems, which should use EX_NOINPUT or
        * EX_CANTCREAT, but rather for higher level permisÂ­
        * sions.
        */
        NoPerm = 77,

        /**
        * Something was found in an unconfigured or misconÂ­
        * figured state.
        */
        Config = 78;
