...
proc ifExpr*(condition: ijoExpr, body: ijoExpr, otherwise: ijoExpr): ijoExpr =
  result = ijoExpr(kind: ijoConditionalExpr, condition: condition, condThen: body, condElse: otherwise)

proc ifExpr*(condition: ijoExpr, body: ijoExpr): ijoExpr =
  result = ijoExpr(kind: ijoConditionalExpr, condition: condition, condThen: body, condElse: nil)

proc loopExpr*(body: ijoExpr): ijoExpr =
  result = ijoExpr(kind: ijoLoopExpr, loopInit: nil, loopCondition: nil, loopIncrement: nil, loopBody: body)

proc loopExpr*(cond: ijoExpr, body: ijoExpr): ijoExpr =
  result = ijoExpr(kind: ijoLoopExpr, loopInit: nil, loopCondition: cond, loopIncrement: nil, loopBody: body)

proc loopExpr*(cond: ijoExpr, increment: ijoExpr, body: ijoExpr): ijoExpr =
  result = ijoExpr(kind: ijoLoopExpr, loopInit: nil, loopCondition: cond, loopIncrement: increment, loopBody: body)

proc loopExpr*(init: ijoExpr, cond: ijoExpr, increment: ijoExpr, body: ijoExpr): ijoExpr =
  result = ijoExpr(kind: ijoLoopExpr, loopInit: init, loopCondition: cond, loopIncrement: increment, loopBody: body)
