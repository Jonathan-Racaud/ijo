...
extern "C"
{
    ...
    /// @brief Copy the content of @p dest into @p src.
    /// @param src The chunk that receives the instructions.
    /// @param dest The chunk that sends the instructions.
    void ChunkAppend(Chunk *src, Chunk *dest);
